    ...
    <Headers>
      ...
      <div class="menu flex flex-1 justify-center items-center">
        <template v-for="menu of menuList" :key="menu.id">
          <div
            @click="changeMenu(menu.id, menu.path)"
            :class="[
              'mr-3',
              'ml-3',
              'px-1.5',
      ...
      <div class="search flex flex-1 justify-end items-center">
        <div
          class="search-input w-50 bg-gray-100 flex items-center rounded-md h-8"
        >
          <Icon
            class="mx-1 mt-1"
            :icon-name="Search"
          ...
          <div class="input-s flex items-center flex-1">
            ...
            <Icon
              @click="clearValue"
              v-if="isShowClose"
              class="mt-1 pl-1 pr-1 cursor-pointer"
              :icon-name="CloseOne"
              theme="outline"
              size="18"
              fill="#333"
